                ...
                <div class="space-y-3 pb-6 border-b border-border/60">
                    ...
                    <?php if ( $product->is_in_stock() ) : ?>
                        <div class="flex items-center gap-2 text-xs text-text-muted">
                            <span class="inline-flex items-center justify-center w-4 h-4 rounded-full bg-emerald-100 text-emerald-700 shrink-0">
                                <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                                </svg>
                            </span>
                            <span>
                                <strong class="font-semibold text-text-main"><?php esc_html_e( 'Op voorraad', 'woo-tailwind' ); ?></strong>
                                <span class="text-text-subtle mx-1">•</span>
                                <span><?php esc_html_e( 'Voor 23:59 besteld, morgen in huis', 'woo-tailwind' ); ?></span>
                            </span>
                        </div>
                    <?php else : ?>
                        <div class="flex items-center gap-2 text-xs text-text-muted">
                            <span class="inline-flex items-center justify-center w-4 h-4 rounded-full bg-slate-100 text-slate-500 shrink-0">
                            ...
                            <span class="font-medium text-text-muted">
                                <?php esc_html_e( 'Tijdelijk niet op voorraad', 'woo-tailwind' ); ?>
                            </span>
                        </div>
                    <?php endif; ?>
                </div>
